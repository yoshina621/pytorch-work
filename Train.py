...
from TrainPytorch import TrainPytorch
from TestPytorch import TestPytorch
...
def start_game():
	manager.registerAI("TrainPytorch", TrainPytorch(gateway))
	print("Start game")
	
	game = manager.createGame("ZEN", "ZEN", "TrainPytorch", "MctsAi_ver4_nonDelay", GAME_NUM)
